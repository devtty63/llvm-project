...
struct ParsedDWARFTypeAttributes {
  ...
  void setIsArtificial() { attr_flags |= eDWARFAttributeArtificial; }
  bool isArtificial() const { return attr_flags & eDWARFAttributeArtificial; }

  void setIsExplicit() { attr_flags |= eDWARFAttributeExplicit; }
  bool isExplicit() const { return attr_flags & eDWARFAttributeExplicit; }

  void setIsForwardDeclaration() { attr_flags |= eDWARFAttributeForwardDecl; }
  bool isForwardDeclaration() const {
    return attr_flags & eDWARFAttributeForwardDecl;
  }

  void setIsInline() { attr_flags |= eDWARFAttributeInline; }
  bool isInline() const { return attr_flags & eDWARFAttributeInline; }

  void setIsScopedEnum() { attr_flags |= eDWARFAttributeScopedEnum; }
  bool isScopedEnum() const { return attr_flags & eDWARFAttributeScopedEnum; }

  void setIsVector() { attr_flags |= eDWARFAttributeVector; }
  bool isVector() const { return attr_flags & eDWARFAttributeVector; }

  void setIsVirtual() { attr_flags |= eDWARFAttributeVirtual; }
  bool isVirtual() const { return attr_flags & eDWARFAttributeVirtual; }

  void setIsExternal() { attr_flags |= eDWARFAttributeExternal; }
  bool isExternal() const { return attr_flags & eDWARFAttributeExternal; }

  void setIsExportsSymbols() { attr_flags |= eDWARFAttributeExportSymbols; }
  bool isExportsSymbols() const {
    return attr_flags & eDWARFAttributeExportSymbols;
  }

  void setIsObjCDirectCall() { attr_flags |= eDWARFAttributeObjCDirect; }
